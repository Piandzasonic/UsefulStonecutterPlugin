...
public class Oak extends InputPlank{
    public Oak(UsefulStonecutterPlugin plugin){
        keys = new ArrayList<>();
        String keyPrefix = "custom_oak_";
        ...
        outputBlocks.add(new ItemStack(Material.OAK_SLAB, 2));
        outputBlocks.add(new ItemStack(Material.OAK_STAIRS));
        outputBlocks.add(new ItemStack(Material.OAK_FENCE, 2));
        outputBlocks.add(new ItemStack(Material.OAK_FENCE_GATE, 2));
        ...
        if(plugin.getServer().getBukkitVersion().contains("1.20")){
            ...
            outputBlocks.add(new ItemStack(Material.OAK_HANGING_SIGN, 2));
        }
    }
}
